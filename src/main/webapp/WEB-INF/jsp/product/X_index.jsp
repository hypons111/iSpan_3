...
<html>
    <head>
		...
		<!-- SweetAlert2 -->
		<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/sweetalert2@11.4.8/dist/sweetalert2.all.min.js"></script>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/admin/member"><div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>會員清單</a>
                                    <a class="nav-link" href="member/add"><div class="sb-nav-link-icon"><i class="fa-solid fa-table-list"></i></div>新增會員</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/admin/product"><div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>商品清單</a>
                            ...
                            <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/admin/order"><div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>訂單清單</a>
                            ...
                            <div class="collapse" id="collapseLayouts3" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/admin/activity"><div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>活動清單</a>
                            ...
                            <div class="collapse" id="collapseLayouts4" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/admin/recipe"><div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>食譜清單</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">XXX管理</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">首頁</a></li>
                            <li class="breadcrumb-item active">XXX管理</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                如有問題, 請洽
                                <a target="_blank" href="https://datatables.net/">admin@gmail.com</a>
                                .
                            </div>
                        </div>
                        <div class="card mb-4">
...
<table id="datatablesSimple">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <p class="productdescription" id="sort">簡介</p>
                                                <input id="description" class="columnSearchInput" type="text" placeholder="" value="">
                                            </th>
                                            <th>
                                                <p class="productstate" id="sort">上架</p>
                                                <input id="state" class="columnSearchInput" type="text" placeholder="" value="">
                                            </th>
                                            <th></th>
                                        </tr>
                                    </thead>
